...
test("sumMultiBalanceOf", function () {
    var balances = {
        "0x0000000000000000000000000000000000000000": "1380309269697565432250",
    };
    generalUtil_1.sumMultiBalanceOf(balances, {
        ethCallCount: 1,
        output: [
            {
                input: {
...
test("sumSingleBalance", function () {
    var balances = {};
    generalUtil_1.sumSingleBalance(balances, "ethereum", "2");
    expect(balances).toMatchInlineSnapshot("\n    Object {\n      \"ethereum\": \"2\",\n    }\n  ");
    generalUtil_1.sumSingleBalance(balances, "ethereum", "5");
    expect(balances).toMatchInlineSnapshot("\n    Object {\n      \"ethereum\": \"7\",\n    }\n  ");
});
